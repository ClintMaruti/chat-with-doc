...
const features = [
  ...
  },
  {
    ...
    description:
      "Our intelligetn chatbot remembers previous interactions, providing a seamless and personalized experience",
    icon: BrainCogIcon,
  },
  {
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <span className="bold">dynamic conversations</span>, enhancing
        ...
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div aria-hidden="true" className="relative">
              <div className="absolute bottom-0 -inset-x-32 bg-transparent-to-t from-white/95 pt-[5%]" />
            </div>
          </div>
        </div>
